...
entity_name="xkev"
project_name="NLP2025_2023011416"
exp_name="TASK_2_2_2"
...
HYDRA_FULL_ERROR=1 python3 -m recipe.era.main_era \
	...
	actor_rollout_ref.actor.era_lb=${era_lb} \
	actor_rollout_ref.actor.era_ub=${era_ub} \
	actor_rollout_ref.actor.era_k=${era_k} \
	actor_rollout_ref.actor.adv_scale=${adv_scale} \
	actor_rollout_ref.actor.topk=${topk} \
